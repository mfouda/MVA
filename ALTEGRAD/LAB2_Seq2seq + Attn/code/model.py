...
class seq2seqModel(nn.Module):
    ...
    def forward(self,input,max_size,is_prod):
        ...
        while True:
            ...
            if not ('sentence_scores' in locals()):
                sentence_scores = torch.empty(word_scores.shape).cuda()
                
            sentence_scores = torch.hstack((sentence_scores,word_scores))
        ...
        if is_prod:
            ...
            return to_return, sentence_scores.T
    ...
    def predict(self,source_nl):
        ...
        scores = attention_sentence.cpu().detach().numpy()
